...
public class CallChainCompareToolV7 {
    ...
    private static final String DEFAULT_TARGET_FUNC = "OpenApiFormCallbackController#errorAddressFormCompletedCallback";
    ...
    private static List<ProjectConfig> defaultProjectConfigs() {
        return Arrays.asList(
                ...
                //         "getAddressErrorPageList"
                // ),
                new ProjectConfig(
                        "waybill",
                        "D:\\git\\usCode\\dbu-mod-waybill",
                        "OpenApiFormCallbackController",
                        "errorAddressFormCompletedCallback"
                ),
                new ProjectConfig(
                        "delivery",
