...
package org.ipring.behavioral.chain.filter;
 ...
 */
@Component
public final class VerificationChainHandler implements AbstractChainHandler<Object> {
    @Override
    public void handler(Object requestParam) {
        System.out.println("VerificationChainHandler run success");
