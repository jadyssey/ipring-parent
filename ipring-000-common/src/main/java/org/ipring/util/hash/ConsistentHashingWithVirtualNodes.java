...
public class ConsistentHashingWithVirtualNodes {
    ...
    public ConsistentHashingWithVirtualNodes(int numberOfReplicas) {
    ...
    public static void main(String[] args) {
        ConsistentHashingWithVirtualNodes hash = new ConsistentHashingWithVirtualNodes(3);
